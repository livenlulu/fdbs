...
var map = L.map('map', {
  ...
  animate: true, 
  duration: 2
  }).setView([40.803445,-73.956713], 18);
  map.addLayer(layer);
  map.setBearing(331);
  ...
  // $.getJSON('data/biz.geojson', function(Biz) {
    ...
    geojson1 = new L.GeoJSON(resta, {
     ...
     geojson2 = new L.GeoJSON(otherf, {
      ...
      geojson3 = new L.GeoJSON(services, {
      style: style,
      onEachFeature: onEachFeature,
      pointTolayer: function (feature, latlng) {
        return L.circleMarker(latlng, bizmarker);
     ...
     geojson5 = new L.GeoJSON(beauhea, {
      style: style,
      onEachFeature: onEachFeature,
      pointTolayer: function (feature, latlng) {
        return L.circleMarker(latlng, bizmarker);
